  ...
  async (
    ...
    try {
      ...
      try {
          ...
          await Notification.insertMany(
            admins.map(
              (admin) => ({
                ...
                title:
                  "New Voter Verification Request",

                message:
                  `${profile.name} has submitted a voter profile for verification.`,
        ...
        console.error(
          "PROFILE ADMIN NOTIFICATION ERROR:",
          notificationError
        );
      }
...
export const updateProfile =
  async (
    ...
    try {
      ...
      // --------------------------------------------------
      // Save previous verification state
      // --------------------------------------------------
      ...
      // ==================================================
      // NOTIFY ADMINS ON RE-VERIFICATION
      // ==================================================

      const sentForReVerification =
        changedVerificationFields &&
      ...
      if (
        ...
        try {
            ...
            await Notification.insertMany(
              admins.map(
                (admin) => ({
                  ...
                  title:
                    "Voter Profile Updated",

                  message:
                    `${profile.name} updated their verified voter profile. The profile has been sent for verification again.`,
          ...
          console.error(
            "PROFILE UPDATE ADMIN NOTIFICATION ERROR:",
            notificationError
          );
        }
      }
